...
1. 预期退出码 0：`go test ./internal/service -run "^TestReadingsDuringMaintenanceKeepCabinLock$|^TestReadingsOnNormalCabinStillRaiseAlarm$" -count=1 -v`
